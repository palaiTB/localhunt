        ...
        <div class="row">
            <div class="col-lg-4 border-right">
                <div class="container mt-4 mb-4">
                    ...
                    <hr>
                    <h6 class="font-weight-bold">NewsPapers</h6>

                    <br>

                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <a href=""><img src="https://www.freshercooker.in/wp-content/uploads/2019/10/0-9.jpeg" style="max-width: 80px;" alt=""></a>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <a href=""><img src="https://pbs.twimg.com/profile_images/1282407636/icon_512.png" style="max-width: 80px;" alt=""></a>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <a href=""><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRllbn1vzcYswkUfiORGrv5ntZB-vDcFHBFWtMwe26ObmmjZ7Cl" style="max-width: 80px;" alt=""></a>
                        </div>
                        <div class="col-lg-4">
